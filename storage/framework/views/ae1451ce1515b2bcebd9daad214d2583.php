        ...
        <nav class="navbar">
                ...
                <div class="nav-menu">
                    <ul class="nav-links">
                        ...
                        <li><a href="<?php echo e(route('user.agenda')); ?>" class="active">Agenda</a></li>
                    </ul>
    ...
    <main class="main-content">
        <div class="container">
            <div class="page-header">
                <h1 class="page-title"><?php echo e(\App\Models\SiteSetting::get('agenda_title', 'Agenda Sekolah')); ?></h1>
                <p class="page-subtitle"><?php echo e(\App\Models\SiteSetting::get('agenda_description', 'Jadwal kegiatan dan acara SMKN 4 Bogor')); ?></p>
            </div>
            ...
            <div class="agenda-grid">
                ...
                <div class="agenda-card">
                    <div class="agenda-date"><?php echo e($item->date_label); ?></div>
                    <h3 class="agenda-title"><?php echo e($item->title); ?></h3>
                    <p class="agenda-description"><?php echo e($item->description); ?></p>
...
</html><?php /**PATH /Users/tanziljws/Downloads/ujikom/resources/views/user/agenda.blade.php ENDPATH**/ ?>