...
<body>
    ...
    <header class="header">
        <nav class="navbar">
            ...
            <div class="nav-menu">
                <ul class="nav-links">
                    <li><a href="<?php echo e(route('user.dashboard')); ?>" class="active">Beranda</a></li>
                ...
                <?php if(auth()->guard()->guest()): ?>
                    <div class="login-dropdown">
                        ...
                        <div class="login-dropdown-menu" id="loginDropdownMenu">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="login-option-item">
                ...
                <?php else: ?>
                    <div class="user-profile">
                        ...
                        <div class="user-dropdown">
                            ...
                            <div class="user-info-email"><?php echo e(Auth::user()->email ?? ''); ?></div>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <section class="hero-section">
                ...
                <?php if($heroImage && !empty($heroImage)): ?>
                    ...
                    ?>
                    <div class="hero-background" style="background-image: url('<?php echo e($imageUrl); ?>');" data-hero-image="<?php echo e($imageUrl); ?>"></div>
                <?php else: ?>
                    
                    <div class="hero-background" data-hero-image="<?php echo e($fallbackImage); ?>"></div>
                <?php endif; ?>
            ...
            <section id="principal-welcome" class="principal-card">
                <div class="principal-photo-wrapper">
                    <img src="<?php echo e(asset('images/kepsek.png')); ?>" alt="Kepala Sekolah" class="principal-photo">
                </div>
                <div class="principal-content">
                    <h2 class="principal-content-title"><?php echo e(\App\Models\SiteSetting::get('home_principal_title', 'Selamat Datang')); ?></h2>
                    <p class="principal-quote">
                        <?php echo e(\App\Models\SiteSetting::get('home_principal_quote', 'Kami percaya bahwa setiap siswa memiliki potensi luar biasa. Misi kami adalah mendampingi mereka untuk menemukan dan mengembangkan kemampuan terbaiknya. Mari jadikan setiap hari di sekolah sebagai langkah menuju masa depan yang sukses dan berkarakter.')); ?>

                    </p>
                    <div>
                        <div class="principal-name"><?php echo e(\App\Models\SiteSetting::get('home_principal_name', 'Drs. Mulyamurpri Hartono, M.SI')); ?></div>
                        <div class="principal-role"><?php echo e(\App\Models\SiteSetting::get('home_principal_role', 'Kepala Sekolah SMKN 4 Bogor')); ?></div>
                    </div>
                </div>
            </section>
            ...
            <section class="quick-access-section">
                ...
                <div class="quick-access-actions">
                    <a href="<?php echo e(route('user.gallery')); ?>" class="quick-btn">
                        <i class="fas fa-images"></i>
                        <span>Galeri</span>
                    </a>
                    <a href="<?php echo e(route('user.informasi')); ?>" class="quick-btn">
                        <i class="fas fa-bullhorn"></i>
                        <span>Informasi</span>
                    </a>
                    <a href="<?php echo e(route('user.agenda')); ?>" class="quick-btn">
                        <i class="fas fa-calendar-alt"></i>
                        <span>Agenda</span>
                    </a>
                    <a href="<?php echo e(route('user.informasi')); ?>#contact" class="quick-btn">
            ...
            <section class="gallery-section">
                ...
                <div class="gallery-scroll-container">
                    <div class="gallery-scroll-wrapper">
                        <?php $__empty_1 = true; $__currentLoopData = $latestGalleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="gallery-card">
                            <?php if($gallery->fotos && $gallery->fotos->count() > 0): ?>
                                <img src="<?php echo e(asset('uploads/galeri/' . $gallery->fotos->first()->file)); ?>" alt="<?php echo e($gallery->post->judul ?? 'Gallery Image'); ?>" class="gallery-image">
                                <div class="gallery-overlay">
                                    <div class="gallery-info">
                                        <h3 class="gallery-title"><?php echo e($gallery->post->judul ?? 'Untitled'); ?></h3>
                                        <span class="gallery-category"><?php echo e($gallery->post->kategori->judul ?? 'Umum'); ?></span>
                                        <span class="photo-count"><?php echo e($gallery->fotos->count()); ?> foto</span>
                                    </div>
                                </div>
                            <?php else: ?>
...
</html><?php /**PATH /Users/tanziljws/Downloads/ujikom/resources/views/user/dashboard.blade.php ENDPATH**/ ?>